        ...
        <div className="flex flex-col gap-12 xl:gap-0 xl:flex-row xl:items-center">
          ...
          <div className="flex-1">
            ...
            >
              ...
              <p className="mb-11">
                Our unweavering commitment to excellence drives every project we undertake.
                From concept to completion, we meticulously craft solutions that embody quality,
